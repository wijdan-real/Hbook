...
<head>
  ...
  <link href="/css/hotelcustomer/bootstrap-datetimepicker.min.css" rel="stylesheet">
  <link href="/css/hotelcustomer/modalform.css" rel="stylesheet">

  <link href='https://fonts.googleapis.com/css?family=Lato' rel='stylesheet'>

  <link rel="stylesheet" href="/css/hotelcustomer/star-rating.css" media="all" type="text/css"/>
  <link rel="stylesheet" href="/css/hotelcustomer/theme.css" media="all" type="text/css"/>

  <link href="/css/hotelcustomer/insideElementDemo.css" rel="stylesheet" type="text/css">

  <link href="/css/hotelcustomer/socialbutton.css" rel="stylesheet">
      ...
      <li>
        <div class="box-vertical well well-sm">
          ...
          <div style=" display: inline;">
            ...
            <div class="inline" style="clear: both;">
              <p style="float: left; margin-left: 22px; font-size: 16px; bottom: 0px;">Heading 1</p>
              <p style="float: right; margin-right: 20px; font-size: 16px; bottom: 0px;">Heading 2</p>
            </div>
    ...
    <div class="row">
      ...
      <!--Grid column-->
        ...
        <div style="" class="col-md-3">
          ...
          <div style=" border-radius: 2px; border:1px white solid; " class="well well-sm sitcolor shadow">
          ...
          <div class="wrapper well well-sm shadow">
      ...
      <div style="" class="col-md-2">
        ...
        <div class="card card-cascade narrower">
          ...
          <br>
          <!--Card content-->
          <div class="well well-sm card-body text-center shadow">
...
<script src="/js/hotelcustomer/star-rating.js" type="text/javascript"></script>
<script src="/js/hotelcustomer//theme.js" type="text/javascript"></script>
<script src="/js/hotelcustomer/LANG.js" type="text/javascript"></script>

 <script src="/js/hotelcustomer/vidbg.min.js"></script>
 <script src="/js/hotelcustomer/jquery.vide.js"></script>
 <script src="/js/hotelcustomer/jquery.vide.min.js"></script>
 <script src="/js/hotelcustomer/socialbutton.js"></script>

<script src="/js/hotelcustomer/moment.min.js"></script>

<script src="/js/hotelcustomer/bootstrap-datetimepicker.min.js"></script>
<script src="/js/hotelcustomer/jquery.payment.min.js"></script>
<script src="/js/hotelcustomer/jquery.validate.min.js"></script>

<script src="/js/hotelcustomer/modalform.js"></script>
...
<script src="/js/hotelcustomer/vanilla-slider.js"></script>
